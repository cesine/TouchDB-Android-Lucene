...
## Usage
You will need a design document to index documents. Refer to the <a href="https://github.com/rnewson/couchdb-lucene/#indexing-strategy">CouchDB-Lucene wiki</a>.

In your activity code use the following snippet to make a request to TDLucene:
```android
try {
