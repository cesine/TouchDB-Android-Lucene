...
public final class HttpClientFactory {
	...
	private static class ShieldedClientConnManager implements
	...
	private static TouchDBHttpClient instance;

	// private static HierarchicalINIConfiguration INI;

	public static synchronized TouchDBHttpClient getInstance(TDServer server)
		...
		if (instance == null) {
			...
			// new ConnPerRouteBean(1000));
			//
			// final SchemeRegistry schemeRegistry = new SchemeRegistry();
			// schemeRegistry.register(new Scheme("touchdb", PlainSocketFactory
			// .getSocketFactory(), 80));
			...
			instance = new TouchDBHttpClient(server);// new
			...
			// final URL url = new URL(Config.url);// Config.getString(key));
			...
			// new PreemptiveAuthenticationRequestInterceptor(), 0);
			// }
		}
		return instance;
	}
